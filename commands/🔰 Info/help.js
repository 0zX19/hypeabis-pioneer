  ...
  run: async (client, message, args, cmduser, text, prefix, player, es, ls) => {
    if (args[0]) {
      ...
      let OverviewEmbed = new MessageEmbed()
        .setColor("WHITE").setThumbnail(es.thumb ? es.footericon : null)
...
<a:adev:847720420140515338> Support [**Premier Crafty**](https://discord.gg/kyGRVPh4xs)`)
        .setImage('https://cdn.discordapp.com/attachments/922681442885054565/923779835640291338/HYPEABIS_PIONEER_BANNER.png')
